...
def prepareDataset():
    BASE = '/home/tdye/LightningFL/data/har/'
...
if __name__ == '__main__':
    clients, trainLoaders, testLoaders = get_har_dataLoaders()
    for _, (data, labels) in enumerate(trainLoaders[clients[5]]):
        print(data.shape)
        print(labels)

    print("============")

    for _, (data, labels) in enumerate(testLoaders[clients[5]]):
        print(data.shape)
        print(labels)
